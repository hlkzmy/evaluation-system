...
CREATE TABLE `evaluate_result` (
  ...
  `evaluate_username` varchar(255) DEFAULT NULL,
  `json_result` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "evaluate_result"
#
...
CREATE TABLE `evaluate_school` (
  ...
  `create_admin_user` varchar(20) DEFAULT NULL,
...
CREATE TABLE `evaluated_person` (
  ...
  `create_admin_user` varchar(255) NOT NULL,
  `insert_time` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `evaluated_person` VALUES (12,'衡磊砢','衡磊砢衡磊砢衡磊砢',22,'admin','2014-07-13 21:00:14'),(14,'沈总','沈总沈总沈总沈总',22,'admin','2014-07-13 21:06:45'),(17,'陈老师','陈老师',23,'hengleike','2014-07-14 14:07:26'),(18,'李老师','李老师',23,'hengleike','2014-07-14 14:08:37'),(19,'李老师1','李老师1',23,'hengleike','2014-07-14 14:08:55'),(20,'王老师','王老师',23,'hengleike','2014-07-14 14:10:06'),(21,'dfgfgfdgdf','dfgfgfdgdf',23,'赵安国','2014-07-14 14:11:25');
...
CREATE TABLE `evaluation` (
  ...
  `evaluate_user_count` varchar(255) DEFAULT NULL,
  `description` longtext,
  `create_admin_user` varchar(255) DEFAULT NULL COMMENT '创建教学评价的超级管理员',
